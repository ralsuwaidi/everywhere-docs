...
- max_nights_of_deal (integer, required): Maximum number of nights the deal applies to
- min_nights (integer, required): Minimum number of nights required for the deal
